...
public class HeaderVersionHandlerMapping extends RequestMappingHandlerMapping {
    ...
    private RequestCondition<ApiVersionHeaderCondition> createCondition(ApiVersion apiVersion) {
        return apiVersion == null ? null : new ApiVersionHeaderCondition(apiVersion.value());
    }
}
